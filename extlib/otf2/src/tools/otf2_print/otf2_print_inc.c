...
#if 0
{
    ...
    printf( "%-*s "
            "%12s"
            "  "
            "globalOffset: %" PRIUint64 ", "
            "traceLength: %" PRIUint64 ", "
            "%s",
...
static OTF2_CallbackCode
print_snap_measurement_on_off( OTF2_LocationRef     locationID,
                               OTF2_TimeStamp       snapTime,
                               void*                userData,
                               OTF2_AttributeList*  attributes,
                               ...
                               OTF2_MeasurementMode measurementMode )
{
    ...
    return print_measurement_on_off( locationID,
                                     origEventTime,
                                     userData,
                                     attributes,
                                     measurementMode );
...
static OTF2_CallbackCode
print_snap_enter( OTF2_LocationRef    locationID,
                  OTF2_TimeStamp      snapTime,
                  void*               userData,
                  OTF2_AttributeList* attributes,
                  OTF2_TimeStamp      origEventTime,
...
static OTF2_CallbackCode
print_snap_mpi_send( OTF2_LocationRef    locationID,
                     OTF2_TimeStamp      snapTime,
                     void*               userData,
                     OTF2_AttributeList* attributes,
                     OTF2_TimeStamp      origEventTime,
                     ...
                     uint64_t            msgLength )
{
    ...
    return print_mpi_send( locationID,
                           origEventTime,
                           userData,
                           attributes,
                           receiver,
...
static OTF2_CallbackCode
print_snap_mpi_isend( OTF2_LocationRef    locationID,
                      OTF2_TimeStamp      snapTime,
                      void*               userData,
                      OTF2_AttributeList* attributes,
                      OTF2_TimeStamp      origEventTime,
                      ...
                      uint64_t            requestID )
{
    ...
    return print_mpi_isend( locationID,
                            origEventTime,
                            userData,
                            attributes,
                            receiver,
...
static OTF2_CallbackCode
print_snap_mpi_isend_complete( OTF2_LocationRef    locationID,
                               OTF2_TimeStamp      snapTime,
                               void*               userData,
                               OTF2_AttributeList* attributes,
                               OTF2_TimeStamp      origEventTime,
                               uint64_t            requestID )
{
    ...
    return print_mpi_isend_complete( locationID,
                                     origEventTime,
                                     userData,
                                     attributes,
                                     requestID );
...
static OTF2_CallbackCode
print_snap_mpi_recv( OTF2_LocationRef    locationID,
                     OTF2_TimeStamp      snapTime,
                     void*               userData,
                     OTF2_AttributeList* attributes,
                     OTF2_TimeStamp      origEventTime,
                     ...
                     uint64_t            msgLength )
{
    ...
    return print_mpi_recv( locationID,
                           origEventTime,
                           userData,
                           attributes,
                           sender,
...
static OTF2_CallbackCode
print_snap_mpi_irecv_request( OTF2_LocationRef    locationID,
                              OTF2_TimeStamp      snapTime,
                              void*               userData,
                              OTF2_AttributeList* attributes,
                              OTF2_TimeStamp      origEventTime,
                              uint64_t            requestID )
{
    ...
    return print_mpi_irecv_request( locationID,
                                    origEventTime,
                                    userData,
                                    attributes,
                                    requestID );
...
static OTF2_CallbackCode
print_snap_mpi_irecv( OTF2_LocationRef    locationID,
                      OTF2_TimeStamp      snapTime,
                      void*               userData,
                      OTF2_AttributeList* attributes,
                      OTF2_TimeStamp      origEventTime,
                      ...
                      uint64_t            requestID )
{
    ...
    return print_mpi_irecv( locationID,
                            origEventTime,
                            userData,
                            attributes,
                            sender,
...
static OTF2_CallbackCode
print_snap_mpi_collective_begin( OTF2_LocationRef    locationID,
                                 OTF2_TimeStamp      snapTime,
                                 void*               userData,
                                 OTF2_AttributeList* attributes,
                                 OTF2_TimeStamp      origEventTime )
{
    ...
    return print_mpi_collective_begin( locationID,
                                       origEventTime,
                                       userData,
                                       attributes  );
}
...
static OTF2_CallbackCode
print_snap_mpi_collective_end( OTF2_LocationRef    locationID,
                               OTF2_TimeStamp      snapTime,
                               void*               userData,
                               OTF2_AttributeList* attributes,
                               OTF2_TimeStamp      origEventTime,
                               ...
                               uint64_t            sizeReceived )
{
    ...
    return print_mpi_collective_end( locationID,
                                     origEventTime,
                                     userData,
                                     attributes,
                                     collectiveOp,
...
static OTF2_CallbackCode
print_snap_omp_fork( OTF2_LocationRef    locationID,
                     OTF2_TimeStamp      snapTime,
                     void*               userData,
                     OTF2_AttributeList* attributes,
                     OTF2_TimeStamp      origEventTime,
                     uint32_t            numberOfRequestedThreads )
{
    ...
    return print_omp_fork( locationID,
                           origEventTime,
                           userData,
                           attributes,
                           numberOfRequestedThreads );
...
static OTF2_CallbackCode
print_snap_omp_acquire_lock( OTF2_LocationRef    locationID,
                             OTF2_TimeStamp      snapTime,
                             void*               userData,
                             OTF2_AttributeList* attributes,
                             OTF2_TimeStamp      origEventTime,
                             ...
                             uint32_t            acquisitionOrder )
{
    ...
    return print_omp_acquire_lock( locationID,
                                   origEventTime,
                                   userData,
                                   attributes,
                                   lockID,
...
static OTF2_CallbackCode
print_snap_omp_task_create( OTF2_LocationRef    locationID,
                            OTF2_TimeStamp      snapTime,
                            void*               userData,
                            OTF2_AttributeList* attributes,
                            OTF2_TimeStamp      origEventTime,
                            uint64_t            taskID )
{
    ...
    return print_omp_task_create( locationID,
                                  origEventTime,
                                  userData,
                                  attributes,
                                  taskID );
...
static OTF2_CallbackCode
print_snap_omp_task_switch( OTF2_LocationRef    locationID,
                            OTF2_TimeStamp      snapTime,
                            void*               userData,
                            OTF2_AttributeList* attributes,
                            OTF2_TimeStamp      origEventTime,
                            uint64_t            taskID )
{
    ...
    return print_omp_task_switch( locationID,
                                  origEventTime,
                                  userData,
                                  attributes,
                                  taskID );
...
static OTF2_CallbackCode
print_snap_metric( OTF2_LocationRef        locationID,
                   OTF2_TimeStamp          snapTime,
                   void*                   userData,
                   OTF2_AttributeList*     attributes,
                   OTF2_TimeStamp          origEventTime,
                   ...
                   const OTF2_MetricValue* metricValues )
{
    ...
    return print_metric( locationID,
                         origEventTime,
                         userData,
                         attributes,
                         metric,
...
static OTF2_CallbackCode
print_snap_parameter_string( OTF2_LocationRef    locationID,
                             OTF2_TimeStamp      snapTime,
                             void*               userData,
                             OTF2_AttributeList* attributes,
                             OTF2_TimeStamp      origEventTime,
                             ...
                             OTF2_StringRef      string )
{
    ...
    return print_parameter_string( locationID,
                                   origEventTime,
                                   userData,
                                   attributes,
                                   parameter,
...
static OTF2_CallbackCode
print_snap_parameter_int( OTF2_LocationRef    locationID,
                          OTF2_TimeStamp      snapTime,
                          void*               userData,
                          OTF2_AttributeList* attributes,
                          OTF2_TimeStamp      origEventTime,
                          ...
                          int64_t             value )
{
    ...
    return print_parameter_int( locationID,
                                origEventTime,
                                userData,
                                attributes,
                                parameter,
...
static OTF2_CallbackCode
print_snap_parameter_unsigned_int( OTF2_LocationRef    locationID,
                                   OTF2_TimeStamp      snapTime,
                                   void*               userData,
                                   OTF2_AttributeList* attributes,
                                   OTF2_TimeStamp      origEventTime,
                                   ...
                                   uint64_t            value )
{
    ...
    return print_parameter_unsigned_int( locationID,
                                         origEventTime,
                                         userData,
                                         attributes,
                                         parameter,
