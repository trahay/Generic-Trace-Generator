...
int main (int argc, char** argv){
    ...
    printf("red: color %s, value %x\n", GTG_RED.color_name, GTG_RED.rgb);
    printf("green: color %s, value %x\n", GTG_GREEN.color_name, GTG_GREEN.rgb);
    printf("white: color %s, value %x\n", GTG_WHITE.color_name, GTG_WHITE.rgb);
    printf("black: color %s, value %x\n", GTG_BLACK.color_name, GTG_BLACK.rgb);
    endTrace ();
    return EXIT_SUCCESS;
}
